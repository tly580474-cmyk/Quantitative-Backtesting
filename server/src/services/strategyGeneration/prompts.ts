...
常用默认值参考：RSI 超卖 30、RSI 超买 70、RSI 卖出超买 80、RSI 卖出超卖 20、BOLL 周期 20、BOLL 标准差 2、MACD 12/26/9、成交量/高低点突破周期 20、回撤周期 60、放量阈值 1.5、回撤阈值 0.08、波动率周期 20、年化波动率阈值 0.35~0.5、BIAS 阈值 ±0.08、反转阈值 ±0.08。
risk 必须是数组。价格/持仓规则使用 { "type":"stopLoss|takeProfit|trailingStop|maxHoldingDays", "value": number }；连亏暂停规则使用 { "type":"lossStreakCooldown", "losses": number, "months": number }。
